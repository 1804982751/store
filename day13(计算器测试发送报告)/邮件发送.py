...
# naefzxupfeqdedfe
sender = "1804982751@qq.com"     # 发送人的邮件
recevises = ["1804982751@qq.com"] # 接收人列表，可以写多个
mail_host = "smtp.qq.com"       # smtp邮箱的服务器地址
password = "naefzxupfeqdedfe"   # 本人邮件发送授权码
...
att1 = MIMEText(open('邮件练习.html','rb').read(),'base64','utf-8')
